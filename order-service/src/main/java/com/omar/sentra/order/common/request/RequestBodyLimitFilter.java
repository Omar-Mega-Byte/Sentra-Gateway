...
import com.omar.sentra.order.common.error.ApiErrorFactory;
import com.omar.sentra.order.common.error.OrderServiceException;
import com.omar.sentra.order.common.error.ServiceErrors;
...
/**
 * Enforces the documented create body limit for fixed and chunked requests.
 */
@Component
...
public class RequestBodyLimitFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        return !"POST".equals(request.getMethod())
                || !"/internal/v1/orders".equals(request.getRequestURI());
    }
