CREATE TABLE gateway_routes (
    ...
    rewrite_regex VARCHAR(500),
    rewrite_replacement VARCHAR(500),
    route_order INTEGER NOT NULL DEFAULT 0,
    enabled BOOLEAN NOT NULL DEFAULT TRUE,
    authentication_types TEXT NOT NULL,
    required_roles TEXT NOT NULL,
    required_scopes TEXT NOT NULL,
    signing_required BOOLEAN NOT NULL DEFAULT FALSE,
    rate_limit_policy_id VARCHAR(120),
    ip_policy_id VARCHAR(120),
    risk_policy_id VARCHAR(120),
    connect_timeout_ms INTEGER NOT NULL DEFAULT 1000,
    response_timeout_ms INTEGER NOT NULL DEFAULT 3000,
    retry_enabled BOOLEAN NOT NULL DEFAULT FALSE,
    retry_max_attempts INTEGER NOT NULL DEFAULT 1,
    retry_methods TEXT NOT NULL DEFAULT '',
    circuit_breaker_enabled BOOLEAN NOT NULL DEFAULT FALSE,
    circuit_breaker_name VARCHAR(120),
    audit_mode VARCHAR(40) NOT NULL DEFAULT 'DENIALS_AND_MUTATIONS',
...
CREATE TABLE api_keys (
    ...
    pepper_version VARCHAR(20) NOT NULL,
...
CREATE INDEX idx_api_keys_prefix_status ON api_keys(prefix, status);
...
CREATE TABLE rate_limit_policies (
    ...
    redis_outage_mode VARCHAR(20) NOT NULL,
    response_headers_enabled BOOLEAN NOT NULL DEFAULT TRUE,
    enabled BOOLEAN NOT NULL DEFAULT TRUE,
    version BIGINT NOT NULL DEFAULT 1,
    created_at TIMESTAMPTZ NOT NULL,
    updated_at TIMESTAMPTZ NOT NULL
...
CREATE INDEX idx_audit_route_time ON audit_events(route_id, event_time DESC);
